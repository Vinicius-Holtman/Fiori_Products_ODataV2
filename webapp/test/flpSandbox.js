		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "List Projects",
									"targetURL": "#brcomproductsproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomproductsproject-display": {
								"semanticObject": "brcomproductsproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.products.project",
									"url": sap.ui.require.toUrl("br/com/products/project")
								}
							}
						}
					}
